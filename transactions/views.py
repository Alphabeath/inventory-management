...
class SupplierCreateView(SuccessMessageMixin, CreateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context["savebtn"] = 'Añadir proveedor'
        return context     
...
class SupplierUpdateView(SuccessMessageMixin, UpdateView):
    ...
    form_class = SupplierForm
    success_url = '/transactions/suppliers'
    success_message = "El proveedor ha sido actualizado satisfactoriamente"
    template_name = "suppliers/edit_supplier.html"
...
class SupplierDeleteView(View):
    ...
    success_message = "El proveedor fue eliminado satisfactoriamente"
    ...
    def post(self, request, pk):
        ...
        if formset.is_valid():
            ...
            for form in formset:                                                # for loop to save each individual form as its own object
                ...
                stock.save()
                billitem.save()
            messages.success(request, "Los artículos comprados han sido registrados satisfactoriamente")
    ...
    def delete(self, *args, **kwargs):
        ...
        for item in items:
            ...
            if stock.is_deleted == False:
                ...
                stock.save()
        messages.success(self.request, "La factura de compra ha sido eliminada satisfactoriamente")
    ...
    def post(self, request):
        ...
        if form.is_valid() and formset.is_valid():
            ...
            for form in formset:                                                # for loop to save each individual form as its own object
                ...
                stock.save()
                billitem.save()
            messages.success(request, "Los artículos vendidos han sido registrados satisfactoriamente")
    ...
    def delete(self, *args, **kwargs):
        ...
        for item in items:
            ...
            if stock.is_deleted == False:
                stock.quantity += item.quantity
                stock.save()
        messages.success(self.request, "La factura de venta ha sido eliminada satisfactoriamente")
...
class PurchaseBillView(View):
    ...
    def post(self, request, billno):
        ...
        if form.is_valid():
            ...
            billdetailsobj.save()
            messages.success(request, "Los detalles de la factura han sido modificados satisfactoriamente")
        context = {
            'bill'          : PurchaseBill.objects.get(billno=billno),
            'items'         : PurchaseItem.objects.filter(billno=billno),
            'billdetails'   : PurchaseBillDetails.objects.get(billno=billno),
