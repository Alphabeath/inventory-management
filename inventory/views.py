...
class StockCreateView(SuccessMessageMixin, CreateView):                                 # createview class to add new stock, mixin used to display message
    ...
    success_message = "El stock fue creado satisfactoriamente"                             # displays message when form is submitted

    def get_context_data(self, **kwargs):                                               # used to send additional context
        context = super().get_context_data(**kwargs)
        context["title"] = 'New Stock'
        context["savebtn"] = 'Añadir al Inventario'
        return context       
...
class StockDeleteView(View):                                                            # view class to delete stock
    ...
    success_message = "El stock fue eliminado satisfactoriamente"                             # displays message when form is submitted
